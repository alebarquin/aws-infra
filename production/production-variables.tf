...
variable "s3_variables" {
  ...
  type        = string
  default     = "tl-hrm-vars-production"
}
...
variable "dns_public" {
  ...
  type        = string
  default     = "hrm-production.tl.techmatters.org"
}
...
variable "rds_final_snapshot_id" {
  ...
  type        = string
  default     = "hrmdb-production-final-snapshot"
}
...
variable "chat_public_dns" {
  ...
  type        = string
  default     = "chat.tl.techmatters.org"
}
